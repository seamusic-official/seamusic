...
export default class AuthService {
    ...
    static async update_user(id: number, username: string): Promise<AxiosResponse> {
        return $api.put(`auth/users/${id}`, {
            "username": username
        });
    }
    static async update_user_picture(id: number, data): Promise<AxiosResponse> {
    ...
    static async update_producer(id: number, data): Promise<AxiosResponse> {
