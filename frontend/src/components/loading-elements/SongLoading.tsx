    ...
    return (
        ...
        >
            ...
            <div className="flex p-1">
                    <div
                        className="min-w-12 h-12 mr-1 animate-pulse bg-gray-300 bg-opacity-10 rounded-md"
                    />
            </div>
            <div className="">
            <a>
                <p className="text-white w-12 h-4 rounded-md animate-pulse bg-gray-300 bg-opacity-10 truncate text-lg lg:w-56"></p>
                    ...
                    <p
                    className="mt-1 text-md font-semibold w-12 h-4 rounded-md animate-pulse bg-gray-300 bg-opacity-10 hover:text-white hover:cursor-pointer"
                    ></p>
