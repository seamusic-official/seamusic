...
const Sidebar = () => {
  ...
  >
    <div className="text-gray-100 my-2 cursor-pointer">
      <h2 className="flex items-center mt-1 mb-1 text-white text-3xl capitalize font-extrabold tracking-tighter" id="">
    ...
    <div className="mt-10 mb-4 border-b border-neutral-800">
      ...
      >
        ...
        <Link to="/liked">
        <h2
          className="text-white text-md font-bold hover:text-white capitalize"
          >Liked songs</h2>
        </ Link>
      </button>
    </div>
      ...
      <div>
        <h2 className="font-semibold text-md ">Project TGC - <DecorText font="semibold">@seamusicmgmt</DecorText></h2> 
        <h2 className="font-semibold text-md ">I ♥ (developer) - <DecorText font="extrabold">@whyspacy</DecorText></h2> 
