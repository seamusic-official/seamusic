            ...
            <div className="justify-between md:mb-0 lg:flex flex-row items-center">
              <div className="mx-2 pt-2 lg:pt-0 flex justify-start items-center w-full lg:w-1/3">
                ...
                <div className="text-gray-300 flex justify-center items-center">
                  <div onClick={() => dispatch(setLike())} className="cursor-pointer flex justify-center items-center">
                  {isLiked ? (
                      <svg
              ...
              <div
                className="lg:w-2/5 w-full flex flex-col justify-center items-center border-0"
              >
                <div
                  className="text-gray-300 lg:mb-3 flex justify-between lg:pb-0 pb-1 w-3/5 lg:w-2/5 items-center"
                >
                  <svg
