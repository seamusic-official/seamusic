...
import { BeatpackService } from "@/services/beatpack-service";
...
export function BeatpackDetail() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await BeatpackService.get_one(Number(id));
