		...
		<MainLayout>
			<div className="">
				<div className=" mt-8 flex items-center md:flex">
					...
					<div className="mt-8 w-full ">
						...
						<p className="text-white mt-1 text-sm font-normal leading-none opacity-70">
							Beatpack - pack of your beats, you can to invite other beatmakers
							on your beatpack
						</p>
						<span className="text-white text-6xl capitalize font-extrabold tracking-tighter">
							<div className="m-1">
								<label
									htmlFor="id"
									className="inline-block  font-extrabold text-sm tracking-wider ">
						...
						<div className="flex items-center mt-2">
							...
							<p className="text-white opacity-70 font-normal text-sm">0 min</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div className="w-full ">
				<div className="w-full p-4">
					...
					<p className="text-white mb-2 text-sm font-normal leading-none opacity-70">
						When you pressed button "Publish", do you accept terms & conditions
						of SeaMusic
					</p>
