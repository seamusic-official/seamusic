...
export function SoundkitDetail() {
  return (
    <>
      <div className="mt-8">
        ...
        <div className="relative">              
            ...
            <div className="m-1">
                <h2
                className="text-gray-50 uppercase text-md overflow-wrap break-all w-64 font-bold tracking-tighter"
            >
        ...
        <div className="">
            ...
            >
            +666 sounds for opium/hardrock, rage, jersey club, detroit/flint <br />
            invite in private channel by @whyspacy<br />
            my old kits - FOREVER, 2093STYLE etc.<br />
            <br /><br />
            discount on all beats (detail after receiving this pack)<br />
            and you will be added to the draw database (next post in my tgc)<br />
            <br /><br />
            to get:<br />
            sub to me (https://t.me/whyspacy) and nevermindaboutme (https://t.me/nevermindaboutme)<br />
            repost this post in your channel or friends<br />
            send proofs me (https://t.me/prodbyspxcyyy)<br />
            </p>
        ...
        <div
            className="flex items-center text-white w-1/2 mx-4 my-2 md:flex"
        >
            <svg
        ...
        >
            ...
            <tbody>
            <Song src={som} name="Каждый из дизайнеров" picture={dess} author="whyspacy?" album="Каждый из дизайнеров" date="02.01.2023"/>
            </tbody>
            </table>
        </div>
