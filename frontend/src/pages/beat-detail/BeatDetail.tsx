    ...
    <MainLayout>
          ...
          <div className="w-full " >
            ...
            <p>Listen the preview before buying</p>
              <div
                className="my-2 h-72 md:h-full md:overflow-hidden"
              >
            ...
            <p>You can to lease or purchase beat for any license, and rules will be you</p>
            <div className="flex flex-wrap">
              <LicenseLink link="" image={data.picture_url} price="contractual" title="exclusive lease" description="you get a ahuenni beat"/>
              <LicenseLink link="" image={data.picture_url} price="contractual" title="exclusive lease" description="you get a ahuenni beat"/>
              <LicenseLink link="" image={data.picture_url} price="contractual" title="exclusive lease" description="you get a ahuenni beat"/>
            </div>
            <h1 className="flex items-center text-white font-extrabold text-2xl mt-6">
