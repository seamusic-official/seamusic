					...
					<div className="flex justify-center mb-48">
						<div className="lg:w-[1200px] md:w-156 w-108 pb-3 ">
							<h1 className="text-white flex justify-center m-2 font-extrabold text-3xl xl:text-4xl mt-6">
								<div>
									Registration on{' '}
									<DecorText font="extrabold">SeaMusic</DecorText>
								</div>
							</h1>
							...
							<form onSubmit={handleSubmit}>
								<div className="flex-col justify-center w-11/12 md:w-4/6 lg:w-4/6 mx-auto ">
									...
									<span className="block mt-2 text-xs font-semibold tracking-wide">
										This appears on your profile.
									</span>
									<div className="flex-grow mt-4">
										<span className="inline-block font-extrabold text-xs mt-2 mb-1 tracking-wider ">
											<span className="mr-1 bg-clip-text text-transparent bg-gradient-to-r from-emerald-800 to-emerald-500">
												*
											</span>
									...
									<div className="flex-col mt-4">
										<span className="mb-1 block font-extrabold text-xs my-2 tracking-wider">
										...
										<div className="flex">
											<label htmlFor="artist" className="flex ">
												...
												/>
												<span className="text-xs my-auto ml-3 mr-8 text-center font-semibold tracking-wide">
													Artist
												</span>
											</label>
										...
										<div className="text-xs tracking-wide font-medium ">
											<span className="inline-block text-center  mb-3">
											...
											<span className="inline-block mx-2 text-center  mb-3">
											...
											<div className=" text-center text-sm my-6">
												...
												<Link href="/auth/login">
													<a className="text-emerald-600 underline">Login</a>.
												</Link>
											</div>
										</div>
									</div>
