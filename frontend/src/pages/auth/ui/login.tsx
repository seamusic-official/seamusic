					...
					<div className="flex justify-center mb-48">
						<div className="lg:w-[1200px] md:w-[1000px] w-108 pb-3 ">
							<h1 className="text-white flex justify-center m-2 font-extrabold xl:text-4xl tracking-tighter text-3xl mt-6">
								Login on{' '}
								<span className="ml-2 bg-clip-text text-transparent bg-gradient-to-r from-emerald-800 to-emerald-500">
									SeaMusic
								</span>
							</h1>
							...
							<form onSubmit={handleSubmit}>
								<div className="flex-col justify-center w-11/12 md:w-4/6 lg:w-4/6 mx-auto ">
									<div className="mt-8">
										<button className="w-full m-1 p-2 uppercase hover:text-black transition duration-200 ease-in-out text-sm font-bold text-white bg-zinc-800/30  rounded-full tracking-widest hover:bg-gray-200 transform hover:scale-105 focus:scale-100 focus:bg-emerald-600 outline-none">
									...
									<div className="flex-grow mt-4">
										<label
											htmlFor="email"
											className="inline-block font-extrabold text-xs my-2 tracking-wider ">
									...
									<div className="flex-col mt-4">
										...
										<div className="text-xs tracking-wide font-medium ">
											<button
												type="submit"
												className="w-full p-2 uppercase text-sm font-bold text-white bg-emerald-600 transition duration-200 ease-in-out rounded-full tracking-widest hover:bg-emerald-700 transform hover:scale-105 focus:scale-100 focus:bg-emerald-800 outline-none">
												SIGN IN
											</button>
