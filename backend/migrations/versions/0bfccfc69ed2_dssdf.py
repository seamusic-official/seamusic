...
Revision ID: 0bfccfc69ed2
Revises: 
Create Date: 2024-07-22 19:52:15.774835
...
def upgrade() -> None:
    ...
    sa.Column('beats_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('is_available', sa.Boolean(), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['beats_id'], ['beats.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_views_beats_id'), 'views', ['beats_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_views_beats_id'), table_name='views')
    op.drop_table('views')
